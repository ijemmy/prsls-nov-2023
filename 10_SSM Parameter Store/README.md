...
If you want to run tests against this temporary environment, you'd need to run `node seed-restaurants.js` again, now that you have an `.env` file for the temporary environment.
